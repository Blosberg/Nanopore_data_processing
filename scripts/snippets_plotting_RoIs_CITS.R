...
CITS_DIR     = "/fast/AG_Akalin/bosberg/nanopore/pipeline_output/20180417_1233_HEK293_polyA_RNA/08_plotdat_vis/"

## ----------------------------------------------------------------------------
PATH_CITS    = paste0( CITS_DIR, "HEK_untreated-olap-m6a_CITS-plotdat.rds")
plotdat_CITS = readRDS( PATH_CITS )
CITS_plotdat_covered <- filter_for_coverage( plotdat_CITS$ROIdat, 
                                             mincov = mincov )
